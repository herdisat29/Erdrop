  ...
  return (
    <>
      <DropdownMenu>
        ...
        >
          <DropdownMenuItem onSelect={() => setTimeout(() => setIsEditOpen(true), 100)} className="hover:bg-surface-container-high focus:bg-surface-container-high cursor-pointer rounded-lg m-1 font-label-bold">
            <Edit2 className="h-4 w-4 mr-2" />
            Edit Project
          </DropdownMenuItem>
          <DropdownMenuItem onSelect={() => setTimeout(() => setIsDeleteDialogOpen(true), 100)} disabled={isDeleting} className="text-error focus:text-error hover:bg-error-container focus:bg-error-container cursor-pointer rounded-lg m-1 font-label-bold">
