        ...
        <div className="w-full max-w-md">
          ...
          <div className="login-card-refined rounded-[1.5rem] p-8 md:p-10 flex flex-col gap-8 bg-white">
            ...
            <div className="flex flex-col gap-3">
              ...
              <button 
                disabled
                className="w-full flex items-center justify-center gap-3 bg-[#111c2c] text-white py-3.5 rounded-xl font-bold text-[14px] opacity-50 cursor-not-allowed"
              >
                ...
                Continue with X (Soon)
              </button>

              <button 
                disabled
                className="w-full flex items-center justify-center gap-3 bg-[#5865F2] text-white py-3.5 rounded-xl font-bold text-[14px] opacity-50 cursor-not-allowed"
              >
