...
export default async function DashboardLayout({
  ...
  return (
    <div className="flex min-h-screen bg-background text-on-surface font-sans overflow-hidden">
      ...
      <nav className="md:hidden fixed bottom-0 left-0 w-full z-40 flex justify-around items-center px-4 pb-4 pt-2 bg-surface/90 backdrop-blur-md rounded-t-xl border-t-2 border-primary-container/20">
        <Link href="/" className="flex flex-col items-center justify-center bg-primary-container text-on-primary-container rounded-full px-6 py-1.5 squishy-interaction">
          <span className="material-symbols-outlined" style={{fontVariationSettings: "'FILL' 1"}}>grid_view</span>
          <span className="font-label-sm text-[10px]">Home</span>
        </Link>
        <Link href="/projects" className="flex flex-col items-center justify-center text-on-surface-variant px-4 py-2 hover:bg-surface-container-highest rounded-full transition-colors squishy-interaction">
          <span className="material-symbols-outlined">folder</span>
          <span className="font-label-sm text-[10px]">Projects</span>
        </Link>
        <Link href="/calendar" className="flex flex-col items-center justify-center text-on-surface-variant px-4 py-2 hover:bg-surface-container-highest rounded-full transition-colors squishy-interaction">
          <span className="material-symbols-outlined">calendar_month</span>
          <span className="font-label-sm text-[10px]">Calendar</span>
        </Link>
        <Link href="/logs" className="flex flex-col items-center justify-center text-on-surface-variant px-4 py-2 hover:bg-surface-container-highest rounded-full transition-colors squishy-interaction">
          <span className="material-symbols-outlined">assignment</span>
          <span className="font-label-sm text-[10px]">Logs</span>
        </Link>
        <Link href="/plan" className="flex flex-col items-center justify-center text-on-surface-variant px-4 py-2 hover:bg-surface-container-highest rounded-full transition-colors squishy-interaction">
          <span className="material-symbols-outlined">psychology</span>
